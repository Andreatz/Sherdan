...
export const BestiaryPage: React.FC = () => {
  ...
  useEffect(() => {
    supabase.from('creatures').select('*').eq('revealed', true)
      .order('created_at', { ascending: false })
      .then(({ data }) => { setCreatures((data as Creature[]) || []); setLoading(false); });
  }, []);
    ...
    <div className="min-h-screen bg-slate-900 pb-16">
      ...
      <div className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <Skull size={40} className="mx-auto mb-4 text-amber-500" />
          <h1 className="text-4xl md:text-5xl font-bold text-amber-300 mb-4">Bestiario</h1>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-10">
          <div className="relative flex-1">
            ...
            <input type="text" placeholder="Cerca creatura..."
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-slate-500">
              {creatures.length === 0 ? 'Nessuna creatura rivelata ancora. Continuate a esplorare...' : 'Nessuna creatura trovata.'}
            </p>
          </div>
        ) : (
