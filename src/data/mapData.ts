...
export interface MapLocation {
  ...
  name: string;
  type: LocationType;
  // coordinate percentuali sull'immagine 5734x4312
  x: number;
  y: number;
...
// Coordinate calibrate sull'immagine Mappa-Sherdan.jpg (% larghezza x % altezza)
export const MAP_LOCATIONS: MapLocation[] = [
  ...
  },
  {
    ...
    x: 78,
    y: 29,
    shortDescription: 'Città nelle anomalie magnetiche del nord-est. Canyon rossi e rocce fluttuanti dovute all\'Obsidium grezzo nel sottosuolo, abitata da Genasi e trib Firbolg.',
